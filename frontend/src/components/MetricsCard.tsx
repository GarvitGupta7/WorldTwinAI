...
export const MetricsCard: React.FC<MetricsCardProps> = ({ definition, name, value }) => {
  ...
  // Calculate percentage along healthy spectrum
  ...
  return (
    <div className={`metric-card ${isHealthy ? 'healthy' : 'anomaly'}`}>
      ...
      <div className="metric-value-row">
        <span className="metric-number">{value.toFixed(2)}</span>
