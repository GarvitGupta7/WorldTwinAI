...
export const GraphViewer = ({
  ...
  const buildings = entities.filter(e => ['building', 'ward', 'terminal', 'zone'].includes(e.entity_type));
  const dynamicEntities = entities.filter(e => ['bus', 'student', 'staff', 'ambulance', 'patient', 'flight'].includes(e.entity_type));

  const getEntityColor = (type, state) => {
