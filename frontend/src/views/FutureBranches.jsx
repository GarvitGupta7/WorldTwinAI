      ...
      <div className="branches-list-card">
        ...
        <div className="branch-items-scroll">
          {branches.map(b => (
            <div
              key={b.id}
              className={`branch-card ${b.id === activeBranchId ? 'active' ) => onSelectBranch(b.id)}
            >
              ...
              {b.parent_branch_id && (
                <div className="b-chain-info">
                  Chained from terminal state of)}
            </div>
          ))}
        </div>
      </div>
        ...
        {comparisonResult && (
          <div className="diff-table-wrapper">
            <table className="diff-table">
              ...
              <tbody>
                {Object.entries(comparisonResult.metric_comparisons).map(([metricName, comp]) => {
